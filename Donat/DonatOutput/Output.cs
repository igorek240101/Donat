...
namespace DonatOutput
{
    public partial class Output : Form
    {
        ...
        public Output()
        {
            ...
            for (int i = v4.Item1; i <= v3.Item1; i++)
            {
                for (int j = v4.Item2; j <= v3.Item2; j++)
                {
                    for (int k = v4.Item3; k <= v3.Item3; k++)
                    {
        ...
        private void Output_Paint(object sender, PaintEventArgs e)
        {
            ...
            {
                graphics.DrawEllipse(pen, value.Item1, value.Item2, 5, 5);
            }
        }
